...
const char* ssid = "vodafone9518";
const char* password = "UDZMJJM5UGMUZM";
const char* mqtt_server = "192.168.0.167";
const char* http_server = "192.168.0.167";
...
void makeGetRequest(String nombreElemento){
    HTTPClient http;
